...
This skill lives at `.cursor/skills/data-visualizer/`. In Cursor, **@mention** the skill file or folder when you want dashboard/chart help (e.g. `@data-visualizer` or `@.cursor/skills/data-visualizer/SKILL.md`), or ask the agent to read and follow that skill before building visualizations.
